...
<ln>
<h1>BIODATA</h1>
            <form action="{{Route ('simpan-data-tugas')}}" method="post">
                {{ csrf_field() }}
        ...
        <!-- Tambahkan opsi lain sesuai kebutuhan -->
            ...
            <select class="form-control" id="range_pendapatan" name="range_pendapatan" required>
        ...
        <!-- Tambahkan opsi lain sesuai kebutuhan -->
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="status_hidup" name="status_hidup" required>
